    ...
    *ainame = NULL;
    ...
    if (index == Proj_Name) {
        ...
        *ainame              = EG_strdup("SU2_Version");
         ...
         * SU2 version to generate specific configuration file. Options: "Cardinal(4.0)", "Raven(5.0)", "Falcon(6.2)", "Blackbird(7.5.1)" or "Harrier(8.0.0)".
         */
