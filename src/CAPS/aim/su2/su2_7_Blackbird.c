...
// Write SU2 configuration file for version Blackbird (7.1.1)
                               ...
                               cfdBoundaryConditionStruct bcProps, int withMotion)
{
    ...
    printf("Write SU2 configuration file for version \"BlackBird (7.1.1) \"\n");
    stringLength = 1
    ...
    fprintf(fp,"%% File Version 7.1.1 \"Blackbird\"                                               %%\n");
    fprintf(fp,"%%                                                                              %%\n");
