...
from corsairlite.analysis.models.aerodynamics.airfoil.kulfan.mses.fullModel import fullModel
...
myProblem = pyCAPS.Problem("hoburg", 
                           capsFile=os.path.join("csm", "kulfan4.csm"), 
                           phaseName="Kulfan4", 
                           phaseStart="FlowTrip", 
...
myProblem.geometry.despmtr["nparams"].value = 4
...
myProblem.geometry.despmtr["aupper"   ].value = [Aupper1, Aupper2, Aupper3, Aupper4]
